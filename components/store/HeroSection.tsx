...
export const HeroSection: React.FC<HeroSectionProps> = ({ carouselItems }) => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 mt-4">
            ...
            <div className={`relative w-full aspect-[16/9] sm:aspect-[21/9] md:aspect-[3/1] lg:aspect-[4/1] min-h-[180px] sm:min-h-[200px] md:min-h-[220px] rounded-xl overflow-hidden shadow-lg group bg-gray-100 ${showSkeleton ? 'hidden' : ''}`}>
