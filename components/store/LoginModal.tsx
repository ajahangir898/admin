// Lazy-loaded LoginModal for better code splitting
...
export interface LoginModalProps {
    onClose: () => void;
    onLogin: (e: string, p: string) => Promise<boolean>;
    onRegister: (u: UserType) => Promise<boolean>;
    onGoogleLogin?: () => Promise<boolean>;
}

export const LoginModal: React.FC<LoginModalProps> = ({ onClose, onLogin, onRegister, onGoogleLogin }) => {
