...
export const CategoriesSection = memo(({ style: _style = 'style5', categories, onCategoryClick, categoryScrollRef: _categoryScrollRef, sectionRef }: Props) => {
  ...
  // Single default style (was style5)
  return (
