...
const initialCategories = [
  ...
  { id: 11, name: "Man Fashion", icon: <Shirt size={14} className="text-blue-500" /> },
  { id: 12, name: "Computer & Gaming", icon: <Monitor size={14} className="text-purple-500" /> },
  { id: 13, name: "Home & Living", icon: <Home size={14} className="text-green-500" /> },
  { id: 14, name: "Grocery & Pet Supplies", icon: <ShoppingCart size={14} className="text-orange-500" /> },
  { id: 15, name: "Health & Beauty", icon: <Sparkles size={14} className="text-pink-500" /> },
  { id: 16, name: "Mobile & Gadgets", icon: <Smartphone size={14} className="text-cyan-500" /> },
  { id: 17, name: "Jewelry", icon: <Heart size={14} className="text-red-400" /> },
  { id: 18, name: "Gift Cards", icon: <Gift size={14} className="text-indigo-500" /> },
  { id: 19, name: "Kids Zone", icon: <span className="text-[14px]">🧸</span> },
  { id: 20, name: "Sports", icon: <span className="text-[14px]">⚽</span> },
];
